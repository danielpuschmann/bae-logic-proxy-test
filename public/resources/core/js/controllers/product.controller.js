...
(function () {
    ...
    angular
        ...
        .controller('ProductImportCtrl', ProductImportController)
    ...
    function ProductImportControllerController($q, $scope, $state, $rootScope, EVENTS, PROMISE_STATUS, ProductSpec, Asset, AssetType, Utils) {
            /* jshint validthis: true */
            var vm = this;
            var createPromise = null;
            var stepList = [
                {
                    title: 'General',
                    templateUrl: 'stock/product/import/general'
                },
                {
                    title: 'Datastore'
                ...
                {
                    title: 'Terms & Conditions',
                    templateUrl: 'stock/product/import/terms'
                },
                {
                    title: 'Finish',
